...
Both datasets were generated by **Dr. Fabian Böttcher** (Technical University of
Munich, Chair of Hydrogeology) using FEFLOW numerical simulations as part of the
[Geo.KW project](https://www.cee.ed.tum.de/hydro/projects/geothermal-energy-group/geokw/).
...
The training datasets were generated by Dr. Fabian Böttcher (TUM) via FEFLOW
