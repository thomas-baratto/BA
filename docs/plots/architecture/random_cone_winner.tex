...
\begin{tikzpicture}
    ...
    \node[frozen block, opacity=0.25, fill opacity=0.25] at (9.66,0.54) {};
    \node[frozen block, opacity=0.25, fill opacity=0.25] at (3.44,0.36) {};
    \node[frozen block, opacity=0.25, fill opacity=0.25] at (6.44,0.36) {};
    \node[frozen block, opacity=0.25, fill opacity=0.25] at (9.44,0.36) {};
    \node[frozen block, opacity=0.25, fill opacity=0.25] at (3.22,0.18) {};
    \node[frozen block, opacity=0.25, fill opacity=0.25] at (6.22,0.18) {};
    \node[frozen block, opacity=0.25, fill opacity=0.25] at (9.22,0.18) {};
    \node[frozen block] (H0) at (3.00,0) {1000\\GELU};
    \node[lbl, above=5mm] at (H0.north) {Random layer 1};
    \node[frozen block] (H1) at (6.00,0) {1000\\GELU};
    \node[lbl, above=5mm] at (H1.north) {Random layer 2};
    \node[frozen block] (H2) at (9.00,0) {1000\\GELU};
    \node[lbl, above=5mm] at (H2.north) {Random layer 3};
    \node[lbl, above=8mm] at (6.00,2.04) {$\times$10 ensemble, SC=dense};
    \node[avg node] (avg) at (11.40,0) {\tiny avg};
    \node[output node] (out_0) at (13.40,0.00) {};
    \node[annot, right=2.5mm of out_0] {Cone};
    \node[lbl, above=5mm] at (13.40,0.00) {Output\\1};
    ...
    % title
%     \node[font=\bfseries, above=8mm] at (current bounding box.north) {edRVFL-SC (Cone)};
\end{tikzpicture}
\end{document}
