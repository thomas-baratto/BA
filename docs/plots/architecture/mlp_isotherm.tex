...
\begin{tikzpicture}
    ...
    \node[hidden block] (H4) at (14.00,0) {256\\GELU};
    \node[lbl, above=5mm] at (H4.north) {Hidden 5};
    \node[output node] (out_0) at (16.80,0.90) {};
    \node[annot, right=2.5mm of out_0] {Area};
    \node[output node] (out_1) at (16.80,0.00) {};
    \node[annot, right=2.5mm of out_1] {Iso\_distance};
    \node[output node] (out_2) at (16.80,-0.90) {};
    \node[annot, right=2.5mm of out_2] {Iso\_width};
    \node[lbl, above=5mm] at (16.80,0.90) {Output\\3};
    ...
    \draw[arr] (H4.east) -- (out_0);
    \draw[arr] (H4.east) -- (out_1);
    \draw[arr] (H4.east) -- (out_2);
\end{tikzpicture}
\end{document}
