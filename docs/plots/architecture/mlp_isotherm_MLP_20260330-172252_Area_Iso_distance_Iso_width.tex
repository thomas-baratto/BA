...
\begin{document}
\begin{tikzpicture}
    \node[input node] (in_0) at (0.00,2.25) {};
    \node[annot, left=2.5mm of in_0] {Flow\_well};
    \node[input node] (in_1) at (0.00,1.35) {};
    \node[annot, left=2.5mm of in_1] {Temp\_diff};
    \node[dots node] (in_dots) at (0.00,0.45) {$\vdots$};
    ...
    \node[input node] (in_4) at (0.00,-2.25) {};
    \node[annot, left=2.5mm of in_4] {Isotherm};
    \node[lbl, above=5mm] at (0.00,2.25) {Input\\9};
    \node[hidden block] (H0) at (2.80,0) {256\\GELU};
    \node[lbl, above=5mm] at (H0.north) {Hidden 1};
    \node[hidden block] (H1) at (5.60,0) {256\\GELU};
    \node[lbl, above=5mm] at (H1.north) {Hidden 2};
    \node[hidden block] (H2) at (8.40,0) {256\\GELU};
    \node[lbl, above=5mm] at (H2.north) {Hidden 3};
    \node[hidden block] (H3) at (11.20,0) {256\\GELU};
    \node[lbl, above=5mm] at (H3.north) {Hidden 4};
    \node[output node] (out_0) at (14.00,0.90) {};
    \node[annot, right=2.5mm of out_0] {Area};
    \node[output node] (out_1) at (14.00,0.00) {};
    \node[annot, right=2.5mm of out_1] {Iso\_distance};
    \node[output node] (out_2) at (14.00,-0.90) {};
    \node[annot, right=2.5mm of out_2] {Iso\_width};
    \node[lbl, above=5mm] at (14.00,0.90) {Output\\3};
    ...
    \draw[arr] (in_4) -- (H0.west);
    \draw[arr] (H0.east) -- (H1.west);
    \draw[arr] (H1.east) -- (H2.west);
    \draw[arr] (H2.east) -- (H3.west);
    \draw[arr] (H3.east) -- (out_0);
    \draw[arr] (H3.east) -- (out_1);
    \draw[arr] (H3.east) -- (out_2);

    % title
    \node[font=\bfseries, above=8mm] at (current bounding box.north) {MLP (Isotherm\_mlp\_20260330-172252\_area\_iso\_distance\_iso\_width)};
\end{tikzpicture}
\end{document}
