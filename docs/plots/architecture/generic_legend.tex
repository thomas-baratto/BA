...
\begin{document}
\begin{tikzpicture}
    \fill[white, rounded corners=2pt, draw=black!25, line width=0.35pt] (0,0) rectangle (4.0,-2.65);
    \draw[random arr] (0.20,-0.43) -- (1.00,-0.43);
    \node[anchor=west, font=\scriptsize] at (1.20,-0.43) {Random frozen weights};
    \draw[learned arr] (0.20,-0.88) -- (1.00,-0.88);
    \node[anchor=west, font=\scriptsize] at (1.20,-0.88) {Learned weights (Ridge)};
    \draw[direct arr] (0.20,-1.33) -- (1.00,-1.33);
    \node[anchor=west, font=\scriptsize] at (1.20,-1.33) {Direct link};
    \draw[arr] (0.20,-1.78) -- (1.00,-1.78);
    \node[anchor=west, font=\scriptsize] at (1.20,-1.78) {Data flow};
    \draw[-{Stealth[length=2.5pt]}, residualcol!80, line width=0.5pt] (0.20,-2.23) -- (1.00,-2.23);
    \node[anchor=west, font=\scriptsize] at (1.20,-2.23) {Residual connection};
\end{tikzpicture}
\end{document}
