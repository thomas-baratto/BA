...
\begin{tikzpicture}
    ...
    \node[hidden block] (H0) at (2.80,0) {64\\ReLU};
    \node[lbl, above=5mm] at (H0.north) {Hidden 1};
    \node[hidden block] (H1) at (5.60,0) {64\\ReLU};
    \node[lbl, above=5mm] at (H1.north) {Hidden 2};
    \node[hidden block] (H2) at (8.40,0) {64\\ReLU};
    \node[lbl, above=5mm] at (H2.north) {Hidden 3};
    \node[output node] (out_0) at (11.20,0.90) {};
    \node[annot, right=2.5mm of out_0] {$y_1$};
    \node[output node] (out_1) at (11.20,0.00) {};
    \node[annot, right=2.5mm of out_1] {$y_2$};
    \node[output node] (out_2) at (11.20,-0.90) {};
    \node[annot, right=2.5mm of out_2] {$y_3$};
    \node[lbl, above=5mm] at (11.20,0.90) {Output\\3};
    ...
    \draw[arr] (H2.east) -- (out_0);
    \draw[arr] (H2.east) -- (out_1);
    \draw[arr] (H2.east) -- (out_2);
\end{tikzpicture}
\end{document}
