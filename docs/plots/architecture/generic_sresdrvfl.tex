...
\begin{document}
\begin{tikzpicture}
    \node[input node] (in_0) at (0.00,1.12) {};
    \node[annot, left=2.5mm of in_0] {$x_1$};
    \node[input node] (in_1) at (0.00,0.38) {};
    ...
    \node[lbl, above=5mm] at (0.00,1.12) {Input\\4};
    \draw[resbox] (2.50,-1.4) rectangle (4.70,1.4);
    \node[lbl] at (3.60,0.90) {Block 1};
    \node[annot] at (3.60,0.15) {2$\times$100, DL};
    \node[annot] at (3.60,-0.25) {ReLU};
    ...
    \node[annot] at (7.10,0.15) {2$\times$100, DL};
    \node[annot] at (7.10,-0.25) {ReLU};
    ...
    \node[annot] at (10.60,0.15) {2$\times$100, DL};
    \node[annot] at (10.60,-0.25) {ReLU};
    ...
    \node[sum node, minimum size=8mm] (sigma) at (12.90,-2.30) {$\Sigma$};
    \draw[arr] (sum0) -- (sigma);
    \draw[arr] (sum1) -- (sigma);
    \draw[arr] (sum2) -- (sigma);
    \node[output node] (out_0) at (15.40,0.75) {};
    \node[annot, right=2.5mm of out_0] {$y_1$};
    \node[output node] (out_1) at (15.40,0.00) {};
    \node[annot, right=2.5mm of out_1] {$y_2$};
    \node[output node] (out_2) at (15.40,-0.75) {};
    \node[annot, right=2.5mm of out_2] {$y_3$};
    \node[lbl, above=5mm] at (15.40,0.75) {Output\\3};
