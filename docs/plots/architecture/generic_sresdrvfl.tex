...
\begin{tikzpicture}
    ...
    \node[sum node, minimum size=8mm] (sigma) at (9.40,-2.30) {$\Sigma$};
    \draw[arr] (sum0) -- (sigma);
    \draw[arr] (sum1) -- (sigma);
    \node[output node] (out_0) at (11.90,0.75) {};
    \node[annot, right=2.5mm of out_0] {$y_1$};
    \node[output node] (out_1) at (11.90,0.00) {};
    \node[annot, right=2.5mm of out_1] {$y_2$};
    \node[output node] (out_2) at (11.90,-0.75) {};
    \node[annot, right=2.5mm of out_2] {$y_3$};
    \node[lbl, above=5mm] at (11.90,0.75) {Output\\3};
