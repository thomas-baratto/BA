...
\begin{tikzpicture}
    ...
    \node[hidden block] (H0) at (2.80,0) {244\\LeakyReLU};
    \node[lbl, above=5mm] at (H0.north) {Hidden 1};
    \node[hidden block] (H1) at (5.60,0) {244\\LeakyReLU};
    \node[lbl, above=5mm] at (H1.north) {Hidden 2};
    \node[output node] (out_0) at (8.40,0.00) {};
    \node[annot, right=2.5mm of out_0] {Cone};
    \node[lbl, above=5mm] at (8.40,0.00) {Output\\1};
