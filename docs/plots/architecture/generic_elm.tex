...
\begin{tikzpicture}
    ...
    \node[output node] (out_0) at (6.40,0.90) {};
    \node[annot, right=2.5mm of out_0] {$y_1$};
    \node[output node] (out_1) at (6.40,0.00) {};
    \node[annot, right=2.5mm of out_1] {$y_2$};
    \node[output node] (out_2) at (6.40,-0.90) {};
    \node[annot, right=2.5mm of out_2] {$y_3$};
    \node[lbl, above=5mm] at (6.40,0.90) {Output\\3};
    ...
    \draw[learned arr] (H0.east) -- (out_0);
    \draw[learned arr] (H0.east) -- (out_1);
    \draw[learned arr] (H0.east) -- (out_2);
