...
|---------|-------|------|-----|------|-----|-------|-----|------------|---------|
| cone | Optimized MLP | MLP | 0.9930 | 0.05 | 0.01 | 0.011658 | 0.9958 | — | 12835 |
| cone | edRVFL-SC (Pareto winner) | RANDOM | 0.9770 | 0.08 | 0.04 | 0.024885 | 0.9871 | 7.1s | 3851 |
| isotherm | Optimized MLP | MLP | 1.0000 | 71.53 | 12.11 | 0.000144 | 0.9999 | — | 85531 |
...
|-------|-----|------|-----|-------|-----|
| Cone | 0.9930 | 0.05 m | 0.01 m | 0.011658 | 0.9958 |
...
| Label | R² | RMSE | MAE | nRMSE | KGE |
|-------|-----|------|-----|-------|-----|
| Area | 1.0000 | 123.87 m² | 35.61 m² | 0.000249 | 0.9999 |
| Iso_distance | 1.0000 | 2.23 m | 0.68 m | 0.001117 | 0.9996 |
| Iso_width | 1.0000 | 0.06 m | 0.03 m | 0.000197 | 1.0000 |
...
- **MLP** achieves R² = 0.9930, nRMSE = 0.011658 on the full dataset.
...
- **MLP** achieves R² = 0.999993, nRMSE = 0.000144 — near-perfect reconstruction of thermal plume geometry.
